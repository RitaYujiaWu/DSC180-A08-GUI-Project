...
def create_selection_action(element_id: str, coords: str, description: str, reasoning: str = "") -> Action:
    """
...
def create_go_back_action(reasoning: str = "") -> Action:
    """
    Create a go back action (navigate to previous page).
    """
    return {
