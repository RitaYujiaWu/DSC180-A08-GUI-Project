...
class TestRunner:
    ...
    def _process_config_file(self, config_file: str):
        ...
        # NOTE: Debug-only: disable early exit on initial navigation blocking.
        # If enabled, the runner skips tasks when the browser lands on about:blank
        # or when the page-parser content check flags the site as blocked.
