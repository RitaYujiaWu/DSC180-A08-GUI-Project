...
def config() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default="examples",
        help="Relative or absolute path to examples directory (e.g. 'evaluation_examples/examples' or '/data/.../examples')",
    )
...
def run_env_tasks(task_queue, args: argparse.Namespace, shared_scores: list):
    ...
    try:
        ...
        while True:
            ...
            try:
                # Build config file path from configurable base and examples dir
