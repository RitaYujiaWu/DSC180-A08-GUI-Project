...
from step_filter import filtered_actions_with_steps
...
def run_single_example(agent, env, example, max_steps, instruction, args, example_result_dir, scores):
    ...
    while not done and step_idx < max_steps:
        ...
        # Decide which actions count as steps and assign step numbers.
        action_step_info, step_idx = filtered_actions_with_steps(actions, step_idx)

        for step_num, action_timestamp, action in action_step_info:
            ...
            with open(os.path.join(example_result_dir, f"step_{step_num}_{action_timestamp}.png"),
                      "wb") as _f:
